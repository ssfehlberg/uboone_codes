...

{
  ...
  TFile *f1=new TFile("mc_tag1_histos.root");
  TFile *f2=new TFile("bnb_tag1_histos.root");
  TFile *f3=new TFile("extbnb_tag1_histos.root");
...
;
  ...
  legend_1->AddEntry(h1_1,"BNB: Tag1","lepf");
  ...
  a1->Draw("SAME");
   ...
   c1->Print("analysis1/MCC9_phi_tag1_all.png");
  ...
  a2->Draw("SAME");
   ...
   c2->Print("analysis1/MCC9_costheta_tag1_all.png");
  ...
  c3->Print("analysis1/MCC9_length_tag1_all.png");
  ...
  c4->Print("analysis1/MCC9_x_tag1_all.png");
  ...
  c5->Print("analysis1/MCC9_y_tag1_all.png");
  ...
  c6->Print("analysis1/MCC9_z_tag1_all.png");
  ...
  c7->Print("analysis1/MCC9_showermult_tag1_all.png");
  ...
  c8->Print("analysis1/MCC9_pfpmult_tag1_all.png");
  ...
  c9->Print("analysis1/MCC9_trackmult_tag1_all.png");
