...

{
  ...
  TFile *f1=new TFile("mc_tag2_histos.root"); //Tag2
  TFile *f2=new TFile("bnb_tag1_histos.root"); //tag1
  TFile *f3=new TFile("extbnb_tag1_histos.root");//Tag1
...
;
  ...
  legend_1->AddEntry(h1,"MC:Tag2","pf");
  legend_1->AddEntry(h1_1,"BNB - EXT: Tag1","lepf");
  ...
  a1->Draw("SAME");
   ...
   c1->Print("analysis_1v2/MCC9_phi.png");
  ...
  legend_2->AddEntry(h2,"MC Tag 2","pf");
  legend_2->AddEntry(h2_1,"BNB - EXT: Tag 1","lepf");
  ...
  a2->Draw("SAME");
   ...
   c2->Print("analysis_1v2/MCC9_costheta.png");
  ...
  legend_3->AddEntry(h3,"MC:Tag 2","pf");
  legend_3->AddEntry(h3_1,"BNB-EXT: Tag 1","lepf");
  ...
  c3->Print("analysis_1v2/MCC9_length.png");
  ...
  legend_4->AddEntry(h4,"MC: Tag 2","pf");
  legend_4->AddEntry(h4_1,"BNB-EXT: Tag 1","lepf");
  ...
  c4->Print("analysis_1v2/MCC9_x.png");
  ...
  legend_5->AddEntry(h5,"MC: Tag 2","pf");
  legend_5->AddEntry(h5_1,"BNB-EXT: Tag 1","lepf");
  ...
  c5->Print("analysis_1v2/MCC9_y.png");
  ...
  legend_6->AddEntry(h6,"MC: Tag 2","pf");
  legend_6->AddEntry(h6_1,"BNB-EXT: Tag 1","lepf");
  ...
  c6->Print("analysis_1v2/MCC9_z.png");
  ...
  legend_7->AddEntry(h7,"MC: Tag 2","pf");
  legend_7->AddEntry(h7_1,"BNB-EXT: Tag 1","lepf");
  ...
  c7->Print("analysis_1v2/MCC9_showermult.png");
  ...
  legend_8->AddEntry(h8,"MC: Tag 2","pf");
  legend_8->AddEntry(h8_1,"BNB-EXT: Tag 1","lepf");
  ...
  c8->Print("analysis_1v2/MCC9_pfpmult.png");
  ...
  legend_9->AddEntry(h9,"MC: Tag 2","pf");
  legend_9->AddEntry(h9_1,"BNB-EXT: Tag 1","lepf");
  ...
  c9->Print("analysis_1v2/MCC9_trackmult.png");
