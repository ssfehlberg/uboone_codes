...
// Tue Oct 23 10:47:00 2018 by ROOT version 6.12/06
// from TTree tree/
// found on file: /pnfs/uboone/scratch/users/sfehlber/oct22/bnb0/bnb0.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/pnfs/uboone/scratch/users/sfehlber/oct22/bnb0/bnb0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/pnfs/uboone/scratch/users/sfehlber/oct22/bnb0/bnb0.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/pnfs/uboone/scratch/users/sfehlber/oct22/bnb0/bnb0.root:/UBXSec");
