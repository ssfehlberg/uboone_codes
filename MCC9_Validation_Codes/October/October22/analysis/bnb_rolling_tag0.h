...
// Tue Oct 23 14:12:40 2018 by ROOT version 6.12/06
// from TTree tree/
// found on file: /pnfs/uboone/scratch/users/sfehlber/oct22/bnb_rolling0/bnb_rolling_tag0.root
//////////////////////////////////////////////////////////

#ifndef bnb_rolling_tag0_h
#define bnb_rolling_tag0_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
 ...
 //UBXSecEvent     *ubxsec_event_split;
   ...
   std::vector<string>  evtwgt_genie_models_multisim_funcname;
   std::vector<int>     evtwgt_genie_models_multisim_nweight;
   std::vector<std::vector<double> > evtwgt_genie_models_multisim_weight;
   ...
   bnb_rolling_tag0(TTree *tree=0);
   virtual ~bnb_rolling_tag0();
...
#ifdef bnb_rolling_tag0_cxx
bnb_rolling_tag0::bnb_rolling_tag0(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/pnfs/uboone/scratch/users/sfehlber/oct22/bnb_rolling0/bnb_rolling_tag0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/pnfs/uboone/scratch/users/sfehlber/oct22/bnb_rolling0/bnb_rolling_tag0.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/pnfs/uboone/scratch/users/sfehlber/oct22/bnb_rolling0/bnb_rolling_tag0.root:/UBXSec");
...
bnb_rolling_tag0::~bnb_rolling_tag0()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t bnb_rolling_tag0::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t bnb_rolling_tag0::LoadTree(Long64_t entry)
{
...
void bnb_rolling_tag0::Init(TTree *tree)
{
...
Bool_t bnb_rolling_tag0::Notify()
{
...
void bnb_rolling_tag0::Show(Long64_t entry)
{
...
Int_t bnb_rolling_tag0::Cut(Long64_t entry)
{
...
#endif // #ifdef bnb_rolling_tag0_cxx
