...
// Tue Oct 23 14:16:20 2018 by ROOT version 6.12/06
// from TTree tree/
// found on file: /pnfs/uboone/scratch/users/sfehlber/oct22/bnb_rolling1/bnb_rolling_tag1.root
//////////////////////////////////////////////////////////

#ifndef bnb_rolling_tag1_h
#define bnb_rolling_tag1_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
 ...
 //UBXSecEvent     *ubxsec_event_split;
   ...
   bnb_rolling_tag1(TTree *tree=0);
   virtual ~bnb_rolling_tag1();
...
#ifdef bnb_rolling_tag1_cxx
bnb_rolling_tag1::bnb_rolling_tag1(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/pnfs/uboone/scratch/users/sfehlber/oct22/bnb_rolling1/bnb_rolling_tag1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/pnfs/uboone/scratch/users/sfehlber/oct22/bnb_rolling1/bnb_rolling_tag1.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/pnfs/uboone/scratch/users/sfehlber/oct22/bnb_rolling1/bnb_rolling_tag1.root:/UBXSec");
...
bnb_rolling_tag1::~bnb_rolling_tag1()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t bnb_rolling_tag1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t bnb_rolling_tag1::LoadTree(Long64_t entry)
{
...
void bnb_rolling_tag1::Init(TTree *tree)
{
...
Bool_t bnb_rolling_tag1::Notify()
{
...
void bnb_rolling_tag1::Show(Long64_t entry)
{
...
Int_t bnb_rolling_tag1::Cut(Long64_t entry)
{
...
#endif // #ifdef bnb_rolling_tag1_cxx
