...
// Tue Oct 23 10:52:31 2018 by ROOT version 6.12/06
// from TTree tree/
// found on file: /pnfs/uboone/scratch/users/sfehlber/oct22/ext0/ext0.root
//////////////////////////////////////////////////////////
...
#ifdef ext0_cxx
ext0::ext0(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/pnfs/uboone/scratch/users/sfehlber/oct22/ext0/ext0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/pnfs/uboone/scratch/users/sfehlber/oct22/ext0/ext0.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/pnfs/uboone/scratch/users/sfehlber/oct22/ext0/ext0.root:/UBXSec");
...
Int_t ext0::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ext0::LoadTree(Long64_t entry)
{
