...
// Tue Oct  9 15:06:36 2018 by ROOT version 6.12/06
// from TTree tree/
// found on file: /uboone/data/users/sfehlber/Oct9/MC_bnb_only_beta1.root
//////////////////////////////////////////////////////////

#ifndef MC_bnb_only_beta1_h
#define MC_bnb_only_beta1_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
 ...
 //UBXSecEvent     *ubxsec_event_split;
   ...
   MC_bnb_only_beta1(TTree *tree=0);
   virtual ~MC_bnb_only_beta1();
...
#ifdef MC_bnb_only_beta1_cxx
MC_bnb_only_beta1::MC_bnb_only_beta1(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/uboone/data/users/sfehlber/Oct9/MC_bnb_only_beta1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/uboone/data/users/sfehlber/Oct9/MC_bnb_only_beta1.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/uboone/data/users/sfehlber/Oct9/MC_bnb_only_beta1.root:/UBXSec");
...
MC_bnb_only_beta1::~MC_bnb_only_beta1()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MC_bnb_only_beta1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MC_bnb_only_beta1::LoadTree(Long64_t entry)
{
...
void MC_bnb_only_beta1::Init(TTree *tree)
{
...
Bool_t MC_bnb_only_beta1::Notify()
{
...
void MC_bnb_only_beta1::Show(Long64_t entry)
{
...
Int_t MC_bnb_only_beta1::Cut(Long64_t entry)
{
...
#endif // #ifdef MC_bnb_only_beta1_cxx
