...

{
  ...
  TFile *f1=new TFile("mc_tag0_histos.root"); //MAKE SURE THESE ARE ALL TAG 0!!!!
  TFile *f2=new TFile("bnb_tag0_histos.root");
  TFile *f3=new TFile("ext_tag0_histos.root");
...
;
  ...
  legend_1->AddEntry(h1,"MC:Tag 0","pf");
  legend_1->AddEntry(h1_1,"BNB: Tag 0","lepf");
  legend_1->AddEntry(h1_2, "EXT: Tag 0","pf");
  ...
  a1->Draw("SAME");
   ...
   c1->Print("analysis0/MCC9_phi_tag0_all.png");
  ...
  legend_2->AddEntry(h2,"MC Tag 0","pf");
  legend_2->AddEntry(h2_1,"BNB Tag 0","lepf");
  legend_2->AddEntry(h2_2, "EXT Tag 0","pf");
  ...
  a2->Draw("SAME");
   ...
   c2->Print("analysis0/MCC9_costheta_tag0_all.png");
  ...
  legend_3->AddEntry(h3,"MC Tag 0","pf");
  legend_3->AddEntry(h3_1,"BNB Tag 0","lepf");
  legend_3->AddEntry(h3_2, "EXT Tag 0","pf");
  ...
  c3->Print("analysis0/MCC9_length_tag0_all.png");
  ...
  legend_4->AddEntry(h4,"MC Tag 0","pf");
  legend_4->AddEntry(h4_1,"BNB Tag 0","lepf");
  legend_4->AddEntry(h4_2, "EXT Tag 0","pf");
  ...
  c4->Print("analysis0/MCC9_x_tag0_all.png");
  ...
  legend_5->AddEntry(h5,"MC Tag 0","pf");
  legend_5->AddEntry(h5_1,"BNB Tag 0","lepf");
  legend_5->AddEntry(h5_2, "EXT Tag 0","pf");
  ...
  c5->Print("analysis0/MCC9_y_tag0_all.png");
  ...
  legend_6->AddEntry(h6,"MC Tag 0","pf");
  legend_6->AddEntry(h6_1,"BNB Tag 0","lepf");
  legend_6->AddEntry(h6_2, "EXT Tag 0","pf");
  ...
  c6->Print("analysis0/MCC9_z_tag0_all.png");
  ...
  legend_7->AddEntry(h7,"MC Tag 0","pf");
  legend_7->AddEntry(h7_1,"BNB Tag 0","lepf");
  legend_7->AddEntry(h7_2, "EXT Tag 0","pf");
  ...
  c7->Print("analysis0/MCC9_showermult_tag0_all.png");
  ...
  legend_8->AddEntry(h8,"MC Tag 0","pf");
  legend_8->AddEntry(h8_1,"BNB Tag 0","lepf");
  legend_8->AddEntry(h8_2, "EXT Tag 0","pf");
  ...
  c8->Print("analysis0/MCC9_pfpmult_tag0_all.png");
  ...
  legend_9->AddEntry(h9,"MC Tag 0","pf");
  legend_9->AddEntry(h9_1,"BNB Tag 0","lepf");
  legend_9->AddEntry(h9_2, "EXT Tag 0","pf");
  ...
  c9->Print("analysis0/MCC9_trackmult_tag0_all.png");
