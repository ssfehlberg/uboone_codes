...

{
  ...
  TFile *f1=new TFile("mc_tag2_histos.root"); //MAKE SURE THESE ARE ALL TAG 0!!!!
...
;
  ...
  legend_1->AddEntry(h1,"MC:Tag 2","pf");
  ...
  a1->Draw("SAME");
   ...
   c1->Print("analysis2/MCC9_phi_tag1_all.png");
  ...
  a2->Draw("SAME");
   ...
   c2->Print("analysis2/MCC9_costheta_tag1_all.png");
  ...
  c3->Print("analysis2/MCC9_length_tag1_all.png");
  ...
  c4->Print("analysis2/MCC9_x_tag1_all.png");
  ...
  c5->Print("analysis2/MCC9_y_tag1_all.png");
  ...
  c6->Print("analysis2/MCC9_z_tag1_all.png");
  ...
  c7->Print("analysis2/MCC9_showermult_tag1_all.png");
  ...
  c8->Print("analysis2/MCC9_pfpmult_tag1_all.png");
  ...
  c9->Print("analysis2/MCC9_trackmult_tag1_all.png");
