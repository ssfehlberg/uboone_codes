...

{
  ...
  TFile *f2=new TFile("bnb_tag0_histos.root"); //BNB tag0
  TFile *f3=new TFile("bnb_rolling_tag0_histos.root"); //BNB Rolling tag0
...
;
  ...
  pad1->cd();  
  h1_1->SetTitle("Phi of Muon; Phi(radians);# of Events");  
  h1_1->Draw("e1");
  ...
  h1_1->GetYaxis()->SetTitleSize(20);
  h1_1->GetYaxis()->SetTitleFont(43);
  h1_1->GetYaxis()->SetTitleOffset(1.5);
  h1_1->SetMaximum(2100);
  ...
  //legend_1->AddEntry(h1,"MC: Tag1","pf");
  legend_1->AddEntry(h1_1,"BNB: Tag 0","lepf");
  legend_1->AddEntry(h1_2, "BNB Rolling: Tag 0","lepf");
  ...
  a1->Draw("SAME");
   ...
   h1_3->GetYaxis()->SetTitle("BNB/(BNB Rolling)");
   ...
   c1->Print("analysis_0v0/MCC9_phi.png");
  ...
  h2_1->SetTitle("Cos(theta) of the Muon; cos(theta);# of Events");
  //hs2->Add(h2);
  //hs2->Add(h2_2);
  h2_1->Draw("e1");
  h2_1->SetLineColor(kRed);
  //h2_1->SetFillColor(kRed);
  h2_1->SetLineWidth(2);
  h2_2->Draw("e1SAME");
  ...
  h2_1->GetYaxis()->SetTitleSize(20);
  h2_1->GetYaxis()->SetTitleFont(43);
  h2_1->GetYaxis()->SetTitleOffset(1.5);
  h2_1->SetMaximum(2000);
  ...
  legend_2->AddEntry(h2_1,"BNB: Tag 0","lepf");
  legend_2->AddEntry(h2_2, "BNB Rolling: Tag 0","lepf");
  ...
  a2->Draw("SAME");
     ...
     // Y axis ratio plot settings
   h2_3->GetYaxis()->SetTitle("BNB/(BNB Rolling)");
   ...
   c2->Print("analysis_0v0/MCC9_costheta.png");
  ...
  pad5->Draw();             
  pad5->cd(); 
  h3_1->SetTitle("Length of the Muon; Length of Track (cm);# of Events");
  //h3->Add(h3);
  //hs3->Add(h3_2);
  h3_1->Draw("e1");
  h3_1->SetLineColor(kRed);
  //h3_1->SetFillColor(kRed);
  h3_1->SetLineWidth(2);
  h3_2->Draw("e1SAME");
  ...
  h3_1->GetYaxis()->SetTitleOffset(1.3);
  h3_1->GetYaxis()->SetTitleSize(20);
  h3_1->GetYaxis()->SetTitleFont(43);
  h3_1->GetYaxis()->SetTitleOffset(1.5);
  h3_1->SetMaximum(3000);
  ...
  legend_3->AddEntry(h3_1,"BNB: Tag 0","lepf");
  legend_3->AddEntry(h3_2, "BNB Rolling: Tag 0","lepf");
  ...
  // Y axis ratio plot settings
  h3_3->GetYaxis()->SetTitle("BNB/(BNB Rolling)");
  ...
  c3->Print("analysis_0v0/MCC9_length.png");
  ...
  pad7->Draw();            
  pad7->cd();               
  h4_1->SetTitle("X Coordinate of Vertex; x (cm) ;# of Events");
  //h4->Add(h4);
  //hs4->Add(h4_2);
  h4_1->Draw("e1");
  h4_1->SetLineColor(kRed);
  //h4_1->SetFillColor(kRed);
  h4_1->SetLineWidth(2);
  h4_2->Draw("e1SAME");
  ...
  h4_1->GetYaxis()->SetTitleSize(20);
  h4_1->GetYaxis()->SetTitleFont(43);
  ...
  legend_4->AddEntry(h4_1,"BNB: Tag 0","lepf");
  legend_4->AddEntry(h4_2, "BNB Rolling: Tag 0","lepf");
  ...
  // Y axis ratio plot settings
  h4_3->GetYaxis()->SetTitle("BNB/(BNB Rolling)");
  ...
  c4->Print("analysis_0v0/MCC9_x.png");
  ...
  pad9->Draw();            
  pad9->cd(); 
  h5_1->SetTitle("Y Coordinate of Vertex; y (cm) ;# of Events");
  //hs5->Add(h5);
  //hs5->Add(h5_2);
  h5_1->Draw("e1");
  h5_1->SetLineColor(kRed);
  //h5_1->SetFillColor(kRed);
  h5_1->SetLineWidth(2);
  h5_2->Draw("e1SAME");
  ...
  h5_1->GetYaxis()->SetTitleOffset(1.3);
  h5_1->GetYaxis()->SetTitleSize(20);
  h5_1->GetYaxis()->SetTitleFont(43);
  h5_1->GetYaxis()->SetTitleOffset(1.5);
  h5_1->SetMaximum(1000);
  ...
  legend_5->AddEntry(h5_1,"BNB: Tag 0","lepf");
  legend_5->AddEntry(h5_2, "BNB Rolling: Tag 0","lepf");
  ...
  // Y axis ratio plot settings
  h5_3->GetYaxis()->SetTitle("BNB/(BNB Rolling)");
  ...
  c5->Print("analysis_0v0/MCC9_y.png");
  ...
  pad11->Draw();            
  pad11->cd(); 
  h6_1->SetTitle("Z Coordinate of Vertex; z (cm) ;# of Events");
  //hs6->Add(h6);
  //hs6->Add(h6_2);
  h6_1->Draw("e1");
  h6_1->SetLineColor(kRed);
  //h6_1->SetFillColor(kRed);
  h6_1->SetLineWidth(2);
  h6_2->Draw("e1SAME");
  ...
  h6_1->GetYaxis()->SetTitleOffset(1.3);
  h6_1->GetYaxis()->SetTitleSize(20);
  h6_1->GetYaxis()->SetTitleFont(43);
  h6_1->GetYaxis()->SetTitleOffset(1.5);
  h6_1->SetMaximum(700);
  ...
  legend_6->AddEntry(h6_1,"BNB: Tag 0","lepf");
  legend_6->AddEntry(h6_2, "BNB Rolling: Tag 0","lepf");
  ...
  // Y axis ratio plot settings
  h6_3->GetYaxis()->SetTitle("BNB/(BNB Rolling)");
  ...
  c6->Print("analysis_0v0/MCC9_z.png");
  ...
  pad17->Draw();            
  pad17->cd();
  h7_1->SetTitle("Shower Multiplicity; Multiplicity ;# of Events");
  //hs7->Add(h7);
  //hs7->Add(h7_2);
  h7_1->Draw("e1");
  h7_1->SetLineColor(kRed);
  //h7_1->SetFillColor(kRed);
  h7_1->SetLineWidth(2);
  h7_2->Draw("e1SAME");
  ...
  h7_1->GetYaxis()->SetTitleOffset(1.3);
  h7_1->GetYaxis()->SetTitleSize(20);
  h7_1->GetYaxis()->SetTitleFont(43);
  h7_1->GetYaxis()->SetTitleOffset(1.5);
  h7_1->SetMaximum(12000);
  ...
  legend_7->AddEntry(h7_1,"BNB: Tag 0","lepf");
  legend_7->AddEntry(h7_2, "BNB Rolling: Tag 0","lepf");
  ...
  // Y axis ratio plot settings
  h7_3->GetYaxis()->SetTitle("BNB/(BNB Rolling)");
  ...
  c7->Print("analysis_0v0/MCC9_showermult.png");
  ...
  pad13->Draw();            
  pad13->cd();
  h8_1->SetTitle("PFP Multiplicity; mult ;# of Events");
  //hs8->Add(h8);
  //hs8->Add(h8_2);
  h8_1->Draw("e1");
  ...
  h8_2->GetYaxis()->SetTitleOffset(1.3);
  h8_2->GetYaxis()->SetTitleSize(20);
  h8_2->GetYaxis()->SetTitleFont(43);
  h8_2->GetYaxis()->SetTitleOffset(1.5);
  //h8_2->SetMaximum(1500);
  ...
  legend_8->AddEntry(h8_1,"BNB: Tag 0","lepf");
  legend_8->AddEntry(h8_2, "BNB Rolling: Tag 0","lepf");
  ...
  // Y axis ratio plot settings
  h8_3->GetYaxis()->SetTitle("BNB/(BNB Rolling)");
  ...
  c8->Print("analysis_0v0/MCC9_pfpmult.png");
  ...
  pad15->Draw();            
  pad15->cd();
  h9_1->SetTitle("Track Multiplicity; mult ;# of Events");
  //hs9->Add(h9);
  //hs9->Add(h9_2);
  h9_1->Draw("e1");
  h9_1->SetLineColor(kRed);
  //h9_1->SetFillColor(kRed);
  h9_1->SetLineWidth(2);
  h9_2->Draw("e1SAME");
  ...
  h9_1->GetYaxis()->SetTitleOffset(1.3);
  h9_1->GetYaxis()->SetTitleSize(20);
  h9_1->GetYaxis()->SetTitleFont(43);
  h9_1->GetYaxis()->SetTitleOffset(1.5);
  h9_1->SetMaximum(8100);
  ...
  legend_9->AddEntry(h9_1,"BNB: Tag 0","lepf");
  legend_9->AddEntry(h9_2, "BNB Rolling: Tag 0","lepf");
  ...
  // Y axis ratio plot settings
  h9_3->GetYaxis()->SetTitle("BNB/(BNB Rolling)");
  ...
  c9->Print("analysis_0v0/MCC9_trackmult.png");
