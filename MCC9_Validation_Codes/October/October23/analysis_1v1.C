...

{
  ...
  TFile *f2=new TFile("bnb_tag1_histos.root"); //BNB tag1
  TFile *f3=new TFile("bnb_rolling_tag1_histos.root"); //BNB Rolling tag1
...
;
  ...
  legend_1->AddEntry(h1_2, "BNB Rolling: Tag 1","lepf");
  ...
  a1->Draw("SAME");
   ...
   c1->Print("analysis_1v1/MCC9_phi.png");
  ...
  legend_2->AddEntry(h2_2, "BNB Rolling: Tag 1","lepf");
  ...
  a2->Draw("SAME");
   ...
   c2->Print("analysis_1v1/MCC9_costheta.png");
  ...
  legend_3->AddEntry(h3_2, "BNB Rolling: Tag 1","lepf");
  ...
  c3->Print("analysis_1v1/MCC9_length.png");
  ...
  legend_4->AddEntry(h4_2, "BNB Rolling: Tag 1","lepf");
  ...
  c4->Print("analysis_1v1/MCC9_x.png");
  ...
  legend_5->AddEntry(h5_2, "BNB Rolling: Tag 1","lepf");
  ...
  c5->Print("analysis_1v1/MCC9_y.png");
  ...
  legend_6->AddEntry(h6_2, "BNB Rolling: Tag 1","lepf");
  ...
  c6->Print("analysis_1v1/MCC9_z.png");
  ...
  legend_7->AddEntry(h7_2, "BNB Rolling: Tag 1","lepf");
  ...
  c7->Print("analysis_1v1/MCC9_showermult.png");
  ...
  legend_8->AddEntry(h8_2, "BNB Rolling: Tag 1","lepf");
  ...
  c8->Print("analysis_1v1/MCC9_pfpmult.png");
  ...
  legend_9->AddEntry(h9_2, "BNB Rolling: Tag 1","lepf");
  ...
  c9->Print("analysis_1v1/MCC9_trackmult.png");
