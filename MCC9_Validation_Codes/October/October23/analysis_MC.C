...

{
  ...
  TFile *f1=new TFile("mc_tag0_histos.root"); //Tag0 MC
  TFile *f2=new TFile("mc_tag1_histos.root"); //Tag1 MC
  TFile *f3=new TFile("mc_tag2_histos.root"); //Tag2 MC
  
  // All the things for the muon candidate: anything with _1 is MC Tag1 and _2 is MC tag2
  TH1D * h1 = (TH1D*)f1->Get("h_truth_phi_muon_mc");
  TH1D * h2 = (TH1D*)f1->Get("h_cos_truth_theta_muon_mc");
  TH1D * h3 = (TH1D*)f1->Get("h_muon_length_mc");
  
  TH1D * h1_1 = (TH1D*)f2->Get("h_truth_phi_muon_mc");
  TH1D * h2_1 = (TH1D*)f2->Get("h_cos_truth_theta_muon_mc");
  TH1D * h3_1 = (TH1D*)f2->Get("h_muon_length_mc");

  TH1D * h1_2 = (TH1D*)f3->Get("h_truth_phi_muon_mc");
  TH1D * h2_2 = (TH1D*)f3->Get("h_cos_truth_theta_muon_mc");
  TH1D * h3_2 = (TH1D*)f3->Get("h_muon_length_mc");
  ...
  TH1D * h4_1 = (TH1D*)f2->Get("h_vertex_x_mc");
  TH1D * h5_1 = (TH1D*)f2->Get("h_vertex_y_mc");
  TH1D * h6_1 = (TH1D*)f2->Get("h_vertex_z_mc");

  TH1D * h4_2 = (TH1D*)f3->Get("h_vertex_x_mc");
  TH1D * h5_2 = (TH1D*)f3->Get("h_vertex_y_mc");
  TH1D * h6_2 = (TH1D*)f3->Get("h_vertex_z_mc");
  ...
  TH1D * h7_1 = (TH1D*)f2->Get("h_shower_mc");
  TH1D * h8_1 = (TH1D*)f2->Get("h_pfp_mc");
  TH1D * h9_1 = (TH1D*)f2->Get("h_track_mc");

  TH1D * h7_2 = (TH1D*)f3->Get("h_shower_mc");
  TH1D * h8_2 = (TH1D*)f3->Get("h_pfp_mc");
  TH1D * h9_2 = (TH1D*)f3->Get("h_track_mc");
...
;
  ...
  THStack *hs1 = new THStack("hs1","Phi of the Muon: Monte Carlo Only");
  //TPad *pad1 = new TPad("pad1", "pad1", 0, 0.3, 1, 1.0);
  //pad1->SetBottomMargin(0); // Upper and lower plot are joined
  //pad1->SetGridx();
  //pad1->Draw();             // Draw the upper pad: pad1
  //pad1->cd();  
  hs1->SetTitle("Phi of Muon: Monte Carlo Only; Phi(radians);# of Events");
  hs1->Add(h1);
  hs1->Add(h1_2);  
  hs1->Draw("hist");
  ...
  legend_1->AddEntry(h1,"Tag 0","pf");
  legend_1->AddEntry(h1_1,"Tag 1","lepf");
  legend_1->AddEntry(h1_2, "Tag 2","pf");
  legend_1->SetTextFont(42);
  legend_1->Draw();   

  c1->Print("analysis_MC/MCC9_phi_MC.png");
  /*
  ...
  */
  ...
  //////////////////////
  TCanvas *c2= new TCanvas("c2","Cos(theta) of the Muon: Monte Carlo Only",1500,1000);
  c2->cd(1);
  
  THStack *hs2 = new THStack("hs2","Cos(theta) of the Muon: Monte Carlo Only");
  ...
  hs2->SetTitle("Cos(theta) of the Muon: Monte Carlo Only; cos(theta);# of Events");
  hs2->Add(h2);
  hs2->Add(h2_2);
  hs2->Draw("hist");
  ...
  legend_2->AddEntry(h2,"Tag 0","pf");
  legend_2->AddEntry(h2_1,"Tag 1","lepf");
  legend_2->AddEntry(h2_2, "Tag 2","pf");
  legend_2->SetTextFont(42);
  legend_2->Draw();

  c2->Print("analysis_MC/MCC9_costheta_MC.png");
  /*
  ...
  */
  ...
  //////////////////////
  TCanvas *c3= new TCanvas("c3","Length of Muon: Monte Carlo only",1500,1000);
  c3->cd(1);
  
  THStack *hs3 = new THStack("hs3","Length of Muon: Monte Carlo Only");
  //TPad *pad5 = new TPad("pad5", "pad5", 0, 0.3, 1, 1.0);
  //pad5->SetBottomMargin(0); 
  //pad5->SetGridx();
  //pad5->Draw();             
  //pad5->cd(); 
  hs3->SetTitle("Length of the Muon: Monte Carlo Only; Length of Track (cm);# of Events");
  hs3->Add(h3);
  hs3->Add(h3_2);
  hs3->Draw("hist");
  ...
  legend_3->AddEntry(h3,"Tag 0","pf");
  legend_3->AddEntry(h3_1,"Tag 1","lepf");
  legend_3->AddEntry(h3_2, "Tag 2","pf");
  legend_3->SetTextFont(42);
  legend_3->Draw();

  c3->Print("analysis_MC/MCC9_length_MC.png");
  /*
  c3->cd();      
  ...
  */
  ...
  //////////////////////////////////////////////////////////////
  TCanvas *c4= new TCanvas("c4","X Coordinate of Vertex: Monte Carlo Only",1500,1000);
  c4->cd(1);
  
  THStack *hs4 = new THStack("hs4","X Coordinate of Vertex: Monte Carlo Only");
  //TPad *pad7 = new TPad("pad7", "pad7", 0, 0.3, 1, 1.0);
  //pad7->SetBottomMargin(0);
  //pad7->SetGridx();
  //pad7->Draw();            
  //pad7->cd();               
  hs4->SetTitle("X Coordinate of Vertex: Monte Carlo Only; x (cm) ;# of Events");
  hs4->Add(h4);
  hs4->Add(h4_2);
  hs4->Draw("hist");
  ...
  legend_4->AddEntry(h4,"Tag 0","pf");
  legend_4->AddEntry(h4_1,"Tag 1","lepf");
  legend_4->AddEntry(h4_2, "Tag 2","pf");
  legend_4->SetTextFont(42);
  legend_4->Draw();

  c4->Print("analysis_MC/MCC9_x_MC.png");
  /*
  c4->cd();      
  ...
  */
  ...
  //////////////////////
  TCanvas *c5= new TCanvas("c5"," Y Coordinate of Vertex: Monte Carlo Only",1500,1000);
  c5->cd(1);
  
  THStack *hs5 = new THStack("hs5","Y Coordinate of Vertex: Monte Carlo Only");
  //TPad *pad9 = new TPad("pad9", "pad9", 0, 0.3, 1, 1.0);
  //pad9->SetBottomMargin(0);
  //pad9->SetGridx();
  //pad9->Draw();            
  //pad9->cd(); 
  hs5->SetTitle("Y Coordinate of Vertex: Monte Carlo Only; y (cm) ;# of Events");
  hs5->Add(h5);
  hs5->Add(h5_2);
  hs5->Draw("hist");
  ...
  legend_5->AddEntry(h5,"Tag 0","pf");
  legend_5->AddEntry(h5_1,"Tag 1","lepf");
  legend_5->AddEntry(h5_2, "Tag 2","pf");
  legend_5->SetTextFont(42);
  legend_5->Draw();

  c5->Print("analysis_MC/MCC9_y_MC.png");
  /*
  c5->cd();      
  ...
  */
  ...
  //////////////////////
  TCanvas *c6= new TCanvas("c6","Z Coordinate of Vertex: Monte Carlo Only",1500,1000);
  c6->cd(1);
  
  THStack *hs6 = new THStack("hs6","Z Coordinate of Vertex: Monte Carlo Only");
  //TPad *pad11 = new TPad("pad11", "pad11", 0, 0.3, 1, 1.0);
  //pad11->SetBottomMargin(0);
  //pad11->SetGridx();
  //pad11->Draw();            
  //pad11->cd(); 
  hs6->SetTitle("Z Coordinate of Vertex: Monte Carlo Only; z (cm) ;# of Events");
  hs6->Add(h6);
  hs6->Add(h6_2);
  hs6->Draw("hist");
  ...
  legend_6->AddEntry(h6,"Tag 0","pf");
  legend_6->AddEntry(h6_1,"Tag 1","lepf");
  legend_6->AddEntry(h6_2, "Tag 2","pf");
  legend_6->SetTextFont(42);
  legend_6->Draw();

  c6->Print("analysis_MC/MCC9_z_MC.png");
  /*
  c6->cd();      
  ...
  */
  ...
  //////////////////////
  TCanvas *c7= new TCanvas("c7","Shower Multiplicity: Monte Carlo Only",1500,1000);
  c7->cd(1);
  
  THStack *hs7 = new THStack("hs7","Shower Multiplicity: Monte Carlo Only");
  //TPad *pad17 = new TPad("pad17", "pad17", 0, 0.3, 1, 1.0);
  //pad17->SetBottomMargin(0);
  //pad17->SetGridx();
  //pad17->Draw();            
  //pad17->cd();
  hs7->SetTitle("Shower Multiplicity: Monte Carlo Only; Multiplicity ;# of Events");
  hs7->Add(h7);
  hs7->Add(h7_2);
  hs7->Draw("hist");
  ...
  legend_7->AddEntry(h7,"Tag 0","pf");
  legend_7->AddEntry(h7_1,"Tag 1","lepf");
  legend_7->AddEntry(h7_2, "Tag 2","pf");
  legend_7->SetTextFont(42);
  legend_7->Draw();

  c7->Print("analysis_MC/MCC9_showermult_MC.png");
  /*
  c7->cd();      
  ...
  */
  ...
  //////////////////////
  TCanvas *c8= new TCanvas("c8","PFP Multiplicity: Monte Carlo Only",1500,1000);
  c8->cd(1);
  
  THStack *hs8 = new THStack("hs8","PFP Multiplicity: Monte Carlo Only");
  //TPad *pad13 = new TPad("pad13", "pad13", 0, 0.3, 1, 1.0);
  //pad13->SetBottomMargin(0);
  //pad13->SetGridx();
  //pad13->Draw();            
  //pad13->cd();
  hs8->SetTitle("PFP Multiplicity: Monte Carlo Only; mult ;# of Events");
  hs8->Add(h8);
  hs8->Add(h8_2);
  hs8->Draw("hist");
  ...
  legend_8->AddEntry(h8,"Tag 0","pf");
  legend_8->AddEntry(h8_1,"Tag 1","lepf");
  legend_8->AddEntry(h8_2, "Tag 2","pf");
  legend_8->SetTextFont(42);
  legend_8->Draw();

  c8->Print("analysis_MC/MCC9_pfpmult_MC.png");
  /*
  c8->cd();      
  ...
  */
  ...
  //////////////////////
  TCanvas *c9= new TCanvas("c9","Track Multiplicity: Monte Carlo Only",1500,1000);
  c9->cd(1);
  
  THStack *hs9 = new THStack("hs9","Track Multiplicity: Monte Carlo Only");
  //TPad *pad15 = new TPad("pad15", "pad15", 0, 0.3, 1, 1.0);
  //pad15->SetBottomMargin(0);
  //pad15->SetGridx();
  //pad15->Draw();            
  //pad15->cd();
  hs9->SetTitle("Track Multiplicity: Monte Carlo Only; mult ;# of Events");
  hs9->Add(h9);
  hs9->Add(h9_2);
  hs9->Draw("hist");
  ...
  legend_9->AddEntry(h9,"Tag 0","pf");
  legend_9->AddEntry(h9_1,"Tag 1","lepf");
  legend_9->AddEntry(h9_2, "Tag 2","pf");
  legend_9->SetTextFont(42);
  legend_9->Draw();

  c9->Print("analysis_MC/MCC9_trackmult_MC.png");
  /*
  c9->cd();      
