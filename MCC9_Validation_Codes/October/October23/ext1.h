...
// Tue Oct 23 14:42:56 2018 by ROOT version 6.12/06
// from TTree tree/
// found on file: /uboone/data/users/renlu23/MCC9/Oct23/extbnb_tag1.root
//////////////////////////////////////////////////////////
...
#ifdef ext1_cxx
ext1::ext1(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/uboone/data/users/renlu23/MCC9/Oct23/extbnb_tag1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/uboone/data/users/renlu23/MCC9/Oct23/extbnb_tag1.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/uboone/data/users/renlu23/MCC9/Oct23/extbnb_tag1.root:/UBXSec");
...
Int_t ext1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ext1::LoadTree(Long64_t entry)
{
