...
// Tue Oct 23 14:40:30 2018 by ROOT version 6.12/06
// from TTree tree/
// found on file: /uboone/data/users/renlu23/MCC9/Oct23/MC_tag1.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/uboone/data/users/renlu23/MCC9/Oct23/MC_tag1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/uboone/data/users/renlu23/MCC9/Oct23/MC_tag1.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/uboone/data/users/renlu23/MCC9/Oct23/MC_tag1.root:/UBXSec");
