...
#define MC_bnb_only_beta1_cxx
#include "MC_bnb_only_beta1.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void MC_bnb_only_beta1::Loop()
{
TFile *tfile = new TFile("MC_bnb_only_histos.root","RECREATE");
  ...
  const double wgt = 0.566;

  //////////////////STUFF FROM ALL  SLICES////////////////

  // All the things for the x,y,z coordinates of the vertex of the slice
  TH1D * h_vertex_x_mc = new TH1D("h_vertex_x_mc","Vertex_x_mc",40,0,275);
  TH1D * h_vertex_y_mc = new TH1D("h_vertex_y_mc","Vertex_y_mc",40,-125,125);
  TH1D * h_vertex_z_mc = new TH1D("h_vertex_z_mc","Vertex_z_mc",50,0,1050);
