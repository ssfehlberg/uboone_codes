...
// Thu Oct  4 09:44:59 2018 by ROOT version 6.12/06
// from TTree tree/
// found on file: /uboone/data/users/sfehlber/Oct4/MC_bnb_only_beta1.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/uboone/data/users/sfehlber/Oct4/MC_bnb_only_beta1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/uboone/data/users/sfehlber/Oct4/MC_bnb_only_beta1.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/uboone/data/users/sfehlber/Oct4/MC_bnb_only_beta1.root:/UBXSec");
