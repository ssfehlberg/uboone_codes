...
;
  ...
  */
  ...
  h1_3->Draw("e1p");
  h1_3->SetMinimum(0);  // Define Y ..
  h1_3->SetMaximum(2.5); // .. range
  ...
  */
  ...
  h2_1->Draw("hist");
  h2_1->SetTitle("Cos(theta) of Muon; Phi(radians);# of Events");
